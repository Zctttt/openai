...
type Config struct {
	...
	ChatMysqlConfig   MysqlConfig   `json:"chat_mysql" mapstructure:"chat_mysql" yaml:"chat_mysql"`
	MarketMysqlConfig MysqlConfig   `json:"market_mysql" mapstructure:"market_mysql" yaml:"market_mysql"`
...
func GetChatMysqlConfig() *MysqlConfig {
	return &config.ChatMysqlConfig
}

func GetMarketMysqlConfig() *MysqlConfig {
	return &config.MarketMysqlConfig
}
